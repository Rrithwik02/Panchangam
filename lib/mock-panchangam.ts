...
export const todaysPanchangam: PanchangamDay = {
  ...
  yoga: "Siddha",
  karana: "Vanija",
  tithis: [{ name: "Shukla Saptami", paksha: "Shukla Paksha" }],
  nakshatras: [{ name: "Swati" }],
  yogas: [{ name: "Siddha" }],
  karanas: [{ name: "Vanija" }],
  samvatsara: "Parabhava (2026)",
  masa: "Shravana",
  ayana: "Dakshinayana",
  ritu: "Varsha",
  ...
  brahmaMuhurtham: { label: "Brahma Muhurtham", start: "04:22 AM", end: "05:10 AM" },
  abhijitMuhurtham: {
  ...
  durmuhurthams: [{ label: "Durmuhurtham", start: "12:18 PM", end: "01:06 PM" }],
  varjyams: [{ label: "Varjyam", start: "08:42 AM", end: "10:18 AM" }],
  amritaKalams: [{ label: "Amrita Kalam", start: "11:24 AM", end: "12:48 PM" }],
